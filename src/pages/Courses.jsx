    ...
    return (
        <section className='w-full bg-gray-200 px-5 py-20'>
            <div className='flex flex-col items-start px-3'>
                <h1 className='text-3xl lg:text-5xl font-medium text-gray-700'>{CONTACT_TITLE}</h1>
                <span className='text-base text-gray-500 lg:text-lg'>{CONTACT_SUB_HEADING}</span>
